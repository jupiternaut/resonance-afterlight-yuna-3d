...
## Latest Checkpoint: refine_art_directed_hair_ribbons_v1_visible_mass

The latest hair pass did not advance `cloth_seam_surface` and did not replace
...
- The visible-mass gate is improved and now passes.
- The route is still rejected as an accepted hair candidate because forbidden
  non-hair leakage is above threshold and the candidate remains visually
